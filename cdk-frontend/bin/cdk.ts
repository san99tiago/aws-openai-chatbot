...
import { CdkOpenAiFrontend } from '../lib/cdk-stack';
...
const myCdkStack = new CdkOpenAiFrontend(
  app,
  MAIN_RESOURCES_NAME,
...
cdk.Tags.of(myCdkStack).add('Usage', 'Frontend that consumes OpenAI Chatbot');
